...
use app\modules\personal\models\ListpersonalSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ListpersonalController implements the CRUD actions for Regpersonal model.
 */
class ListpersonalController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new ListpersonalSearch();
